...
//        LAYERS_TO_LOADERS.put();
        ...
        layersToLoaders.put(new ResourceLocation("textures/atlas/banner_patterns.png"), new ResourceLocation("stack_the_cards", "card_backs"));
    ...
    private static void injected(CallbackInfo ci, @Local LocalRef<Map<ResourceLocation, ResourceLocation>> layersToLoadersCapture) {
        ...
        layersToLoaders.put(new ResourceLocation("textures/atlas/card_backs.png"), new ResourceLocation("stack_the_cards", "card_backs"));
